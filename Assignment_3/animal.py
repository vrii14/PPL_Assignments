...
class Dog:
	...
	def __init__(self, dname = "Ronny", dage = 30):
		self.__dname = dname
		self.__dage = dage


	def __name(self):
		print("I am a dog and my name is {}".format(self.__dname))

	def __age(self):
		print("My age is {}".format(self.__dage))
...
class Lion:
	...
	def __name(self):
		print("I am a lion and my name is {}".format(self.__lname))
...
class Zebra:
	...
	def __init__(self, zname = "Zed", zage = 28):
		self.zname = zname
		self.__zage = zage
	...
	def __age(self):
		print("My age is {}".format(self.__zage))
